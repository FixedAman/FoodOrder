const Contact = () => {
  return (
    <>
      ...
      <form className="form ">
      <h1 className="text-3xl font-bold text-amber-600 mb-7 font-serif">Contact Us</h1>
        <div className="flex flex-col mb-4">
            <label htmlFor="username" className="text-amber-700 font-bold font-serif">User Name</label>
        ...
        <div className="flex flex-col mb-4">
            <label htmlFor="email" className="text-amber-700 font-bold  font-serif">Email</label>
        ...
        <div className="flex flex-col mb-4">
            <label htmlFor="message" className="text-amber-700 font-bold font-serif">Message</label>
